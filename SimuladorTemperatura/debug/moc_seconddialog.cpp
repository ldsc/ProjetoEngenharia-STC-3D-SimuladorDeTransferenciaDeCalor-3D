...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SecondDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SecondDialog_t qt_meta_stringdata_SecondDialog = {
    {
QT_MOC_LITERAL(0, 12), // "SecondDialog"
...
QT_MOC_LITERAL(60, 21) // "on_pushButton_clicked"
    ...
    "SecondDialog\0on_buttonBox_accepted\0\0"
...
void SecondDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SecondDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject SecondDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_SecondDialog.offsetsAndSize,
    qt_meta_data_SecondDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SecondDialog_t
